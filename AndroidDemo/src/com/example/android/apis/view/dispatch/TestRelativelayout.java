...
public class TestRelativelayout extends RelativeLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        System.out.println("TestRelativelayout.dispatchTouchEvent()");
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i(tag, "TestRelativelayout-dispatchTouchEvent-ACTION_DOWN...");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.i(tag, "TestRelativelayout-dispatchTouchEvent-ACTION_MOVE...");
                break;
            case MotionEvent.ACTION_UP:
                Log.i(tag, "TestRelativelayout-dispatchTouchEvent-ACTION_UP...");
                break;
            default:
                break;
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i(tag, "TestRelativelayout-onInterceptTouchEvent-ACTION_DOWN...");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.i(tag, "TestRelativelayout-onInterceptTouchEvent-ACTION_MOVE...");
                break;
            case MotionEvent.ACTION_UP:
                Log.i(tag, "TestRelativelayout-onInterceptTouchEvent-ACTION_UP...");
                break;
            default:
                break;
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        // TODO Auto-generated method stub
        System.out.println("TestRelativelayout.onTouchEvent()");
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i(tag, "TestRelativelayout-onTouchEvent-ACTION_DOWN...");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.i(tag, "TestRelativelayout-onTouchEvent-ACTION_MOVE...");
                break;
            case MotionEvent.ACTION_UP:
                Log.i(tag, "TestRelativelayout-onTouchEvent-ACTION_UP...");
                break;
            default:
                break;
        }
