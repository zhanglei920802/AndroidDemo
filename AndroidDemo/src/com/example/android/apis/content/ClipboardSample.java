...
public class ClipboardSample extends Activity {
    ...
    public void pastePlainText(View button) {
        ClipData clipData = ClipData.newPlainText("Styled Text", mPlainText);
        clipData.addItem(new ClipData.Item("Styled Text1", "text1"));
        clipData.addItem(new ClipData.Item("Styled Text2", "text2"));
        clipData.addItem(new ClipData.Item("Styled Text3", "text3"));
        clipData.addItem(new ClipData.Item("Styled Text4", "text4"));
        clipData.addItem(new ClipData.Item("Styled Text5", "text5"));
    ...
    void logClipData() {
        ...
        stringBuilder.append("ClipData:{").append("\r\n");
        ...
        if (null != clipData && clipData.getItemCount() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (null != item) {
                    stringBuilder.append(String.format("index=[%s], item.Data=[%s]", i, item.coerceToText(this)));
                    stringBuilder.append("\r\n");
                }
            }
        }
        stringBuilder.append("}");
        Log.e("ray", stringBuilder.toString());
    }
}
