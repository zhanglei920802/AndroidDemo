...
public class StatusBarNotifications extends Activity {
    ...
    private void setMood(int moodId, int textId, boolean showTicker) {
        ...
        builder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.icon48x48_2));
        //builder.setSmallIcon(R.drawable.yellow);
        builder.setTicker(getString(textId));
        builder.setShowWhen(true);
        builder.setContentTitle("title");
        builder.setContentText("text");
        // Set the icon, scrolling text and timestamp
        Notification notification = builder.build();
        notification.icon = R.drawable.icon48x48_1;
