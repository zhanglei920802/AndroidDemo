...
public class AlertDialogSamples extends Activity {
    ...
    private void setDialogBottom(Dialog dialog) {
        ...
        System.out.println("AlertDialogSamples.setDialogBottom()"+width);
    }
    @Override
    protected Dialog onCreateDialog(int id) {
        switch (id) {
        case DIALOG_YES_NO_MESSAGE:
            AlertDialog dialog = new  AlertDialog.Builder(AlertDialogSamples.this)
...
//                ContextThemeWrapper themeWrapper = new ContextThemeWrapper(AlertDialogSamples.this,android.R.style.Widget_PopupWindow);
//                AlertDialog dialog = new  AlertDialog.Builder(AlertDialogSamples.this)
//                .setIconAttribute(android.R.attr.alertDialogIcon)
//                .setTitle(R.string.alert_dialog_two_buttons_title)
//                .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
...
//         //  dialog.getWindow().setLayout(720, 1280); //Controlling width and height
////              setDialogBottom(dialog);   Window window = dialog.getWindow();
//                Window window = dialog.getWindow();
//                WindowManager.LayoutParams wlp = new        WindowManager.LayoutParams();
//            wlp.copyFrom(dialog.getWindow().getAttributes());
//            wlp.gravity = Gravity.BOTTOM;
...
//            window.setAttributes(wlp);
                ...
                View customView = inflater.inflate(R.layout.dialogest, null);
                // Build the dialog
                ...
                window.setGravity(Gravity.BOTTOM);  //此处可以设置dialog显示的位置
                    window.setWindowAnimations(R.style.MyAnimation);  //添加动画
                alertDialog.show();
            }
        });
